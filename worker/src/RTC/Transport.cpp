...
namespace RTC
{
	...
	void Transport::HandleRequest(Channel::ChannelRequest* request)
	{
		...
		switch (request->method)
		{
			...
			case Channel::ChannelRequest::Method::CONSUMER_CHANGE_PRODUCER:
			{
				const auto* body = request->data->body_as<FBS::Transport::ChangeProducerRequest>();
	...
	inline void Transport::OnConsumerChangeProducer(RTC::Consumer* consumer, const std::string& producerId)
	{
		MS_TRACE();
